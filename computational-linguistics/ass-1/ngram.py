...
class BasicNgram(ConditionalProbDist):
    ...
    """
    example-
    corpus=["He", "plays", "cricket", "here"]
    ngram,                   context(preceding word),       outcome(the word itself)
    ('<$>', 'He')            ('<$>',)                           He
    ('He', 'plays')          ('He',)                            plays
    ('plays', 'cricket')     ('plays',)                         cricket
    ('cricket', 'here')      ('cricket',)                       here
    """
    def _train(self):       
    ...
    """                                                                                                                                                                                                                                                                                                                                                               
    Return the list of contexts (or the preceding word)
    It will never print the last word in the given corpus, becuase the last word never acts as a context.                                                                                                                                                                                                                                                                                                                                  
    """
    def contexts(self):
